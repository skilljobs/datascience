...
export default function StickyEnrollButton() {
  return (
    <div>
      <div className=" p-6  flex items-center justify-center gap-8 bg-gray-900">
        <h3 className={`text-white text-xl font-semibold ${hindSiliguri.className}`}>সিট সংখ্যা শেষ হওয়ার আগে জয়েন করুন</h3>
        <Link href="/enroll" className=" items-center gap-3 flex bg-red-600 hover:bg-red-700 duration-300 text-white font-bold py-2 px-4 rounded">
