      ...
      <div className=" hidden text-center mb-8 max-w-3xl mx-auto">
        <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 text-sm font-medium mb-10 hover:bg-blue-100 transition-colors cursor-pointer">
          <span>
            ...
            >
              <path
                d="m4.167 15.498 2.701-6.302a.5.5 0 0 0-.459-.698H4.434a.5.5 0 0 1-.46-.698l3.06-7a.5.5 0 0 1 .458-.3h5.133a.5.5 0 0 1 .39.813l-2.7 3.375a.5.5 0 0 0 .39.812h2.255a.5.5 0 0 1 .354.854L4.167 15.5Z"
                stroke="#006CFA"
                strokeLinecap="round"
        ...
        <h1 className="text-[2.55rem] leading-tight max-w-[22ch] mx-auto font-bold text-gray-900 mb-6">
          Create engaging courses in minutes, not months
        </h1>

        <p className="text-[1.250rem] text-gray-700 mb-12">
          Building courses should be a delight, not a drag. Design your course
          in record time with our world-class authoring experience.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {[
            ...
            >
              ...
              <div
                className={`text-gray-600 text-lg  ${hindSiliguri.className}`}
              >
                {stat.label}
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center sm:justify-between justify-center w-full  p-4 bg-[#F9FAFB] rounded-xl">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1">
                  <div
                    className={`text-lg text-blue-600 font-bold ${hindSiliguri.className}`}
                  >
                    কোর্সটি শুরু:
                  </div>
