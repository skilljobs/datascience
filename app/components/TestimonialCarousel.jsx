...
export default function Testimonials() {
  const testimonials = [
    ...
    },
    {
      ...
      content: "The Data Science and Machine Learning Zero to Mastery course at Skill Jobs is exceptional. The curriculum is thorough, the projects are hands-on, and the mentorship is outstanding. It's perfect for mastering data science.",
    },
    {
      id: "3",
            ...
            <div className="flex items-start gap-4 h-full">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center">
                  {/* <span className="text-sm font-medium text-gray-900">{testimonial.initials}</span> */}
                  <Image src={testimonial.src} width={100} height={100} alt="" className="rounded-full" />
                </div>
              </div>
              <div className="flex-1">
                <h3 className="font-medium text-gray-900 mb-1">{testimonial.name}</h3>
